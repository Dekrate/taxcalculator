 ...
 */
public class SocialContributions {
     ...
     */
    private SocialContributions(BigDecimal socialSecurity, BigDecimal healthSocialSecurity,
                               BigDecimal sicknessSocialSecurity) {
     ...
     */
    public static SocialContributions calculate(BigDecimal grossIncome) {
     ...
     */
    public BigDecimal getIncomeAfterContributions(BigDecimal grossIncome) {
    ...
    public BigDecimal getHealthSocialSecurity() {
        return healthSocialSecurity;
    }

    public BigDecimal getSicknessSocialSecurity() {
        return sicknessSocialSecurity;
    }
}
